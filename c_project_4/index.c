...
int main()
{
	...
	printf("> Press0the quit the game\n");
	scanf("%d", &i);
	if(i==7)
	{
	...
	if(i==7)
	{
		...
		{
			printf("wrong Answer alhmare\n");
			point01 = 0;
			printf("You have scored %d point\n", point01);
		}
		printf("2) Which one is the first web berowser inventer in 1990?\n\n");
		printf("1) Internet Explore\n");
		printf("2) Mosaic\n");
		printf("3) Mozilla\n");
		printf("4) Nexus\n");
		printf("Enter Your Answer :");
